...
def process_file(filepath: str, pipeline: Pipeline, config: TokenChunkingConfig,
                 output_dir: str) -> str:
    ...
    out_name = f"{os.path.splitext(filename)[0]}_token.json"
