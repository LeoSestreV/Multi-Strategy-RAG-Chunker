...
def process_file(filepath: str, pipeline: Pipeline, config: DocumentChunkingConfig,
                 output_dir: str) -> str:
    ...
    result = {
        ...
        "strategy": "document_based_chunking",
    ...
    out_name = f"{os.path.splitext(filename)[0]}_document.json"
