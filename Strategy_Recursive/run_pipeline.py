...
def process_file(filepath: str, pipeline: Pipeline, config: RecursiveChunkingConfig,
                 output_dir: str) -> str:
    ...
    result = {
        ...
        "strategy": "recursive_character_chunking",
    ...
    out_name = f"{os.path.splitext(filename)[0]}_recursive.json"
